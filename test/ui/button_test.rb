...
class ButtonTest < ActionView::TestCase
  ...
  test "button" do
    actual   = UiBibz::Ui::Core::Inputs::Buttons::Button.new('state', status: :success).render
  ...
  test 'button group' do
    actual = UiBibz::Ui::Core::Inputs::Buttons::ButtonGroup.new position: :vertical do
      UiBibz::Ui::Core::Inputs::Buttons::Button.new('state').render
    end.render
  ...
  test 'link button' do
    actual   = UiBibz::Ui::Core::Inputs::Buttons::ButtonLink.new('state', { url: users_path, status: :danger, glyph: 'add'}).render
  ...
  test 'button outline' do
    actual   = UiBibz::Ui::Core::Inputs::Buttons::Button.new('state', status: :success, outline: true).render
  ...
  test 'checkbox button checked' do
    actual   = UiBibz::Ui::Core::Inputs::Buttons::ButtonChoice.new('state', { state: :active }).render
  ...
  test 'checkbox button non checked' do
    actual   = UiBibz::Ui::Core::Inputs::Buttons::ButtonChoice.new('state', { name: 'state', id: 'state', input_html_options: { class: 'state'}}).render
  ...
  test 'button group choice checkbox' do
    actual = UiBibz::Ui::Core::Inputs::Buttons::ButtonGroup.new do
      concat UiBibz::Ui::Core::Inputs::Buttons::ButtonChoice.new('state1').render
      concat UiBibz::Ui::Core::Inputs::Buttons::ButtonChoice.new('state2').render
    end.render
  ...
  test 'button group choice radio' do
    actual = UiBibz::Ui::Core::Inputs::Buttons::ButtonGroup.new do
      concat UiBibz::Ui::Core::Inputs::Buttons::ButtonChoice.new('state1', type: :radio).render
      concat UiBibz::Ui::Core::Inputs::Buttons::ButtonChoice.new('state2', type: :radio).render
    end.render
