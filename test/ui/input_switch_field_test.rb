...
class ChoicesSwitchFieldTest < ActionView::TestCase
    ...
    test 'switch_field size' do
      actual = UiBibz::Ui::Core::Inputs::Choices::SwitchField.new('test', size: :lg).render
    ...
    test 'switch_field animate' do
      actual = UiBibz::Ui::Core::Inputs::Choices::SwitchField.new('test', animate: false).render
    ...
    test 'switch_field checked' do
      actual = UiBibz::Ui::Core::Inputs::Choices::SwitchField.new('test', {}, checked: true).render
    ...
    test 'switch_field state' do
      actual = UiBibz::Ui::Core::Inputs::Choices::SwitchField.new('test', {}, state: "disabled").render
    ...
    test 'switch_field readonly' do
      actual = UiBibz::Ui::Core::Inputs::Choices::SwitchField.new('test', {}, readonly: true).render
    ...
    test 'switch_field left_color' do
      actual = UiBibz::Ui::Core::Inputs::Choices::SwitchField.new('test', left_color: "success").render
    ...
    test 'switch_field right_color' do
      actual = UiBibz::Ui::Core::Inputs::Choices::SwitchField.new('test', right_color: "info").render
    ...
    test 'switch_field middle_text' do
      actual = UiBibz::Ui::Core::Inputs::Choices::SwitchField.new('test', middle_text: "testlabeltext").render
    ...
    test 'switch_field left_text' do
      actual = UiBibz::Ui::Core::Inputs::Choices::SwitchField.new('test', left_text: 'testonlabel').render
    ...
    test 'switch_field right_text' do
      actual = UiBibz::Ui::Core::Inputs::Choices::SwitchField.new('test', right_text: "testofflabel").render
