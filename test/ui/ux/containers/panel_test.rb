...
class CardTest < ActionView::TestCase
  ...
  test 'panel with group' do
    ...
    expected = "<div class=\"panel\"><div class=\"panel-header justify-content-between\"><div class=\"panel-title\">Main panel header</div></div><div class=\"btn-toolbar justify-content-between panel-toolbar\" role=\"toolbar\"><div role=\"group\" class=\"btn-group btn-group-sm mr-2\"><button class=\"btn btn-sm\">Copy</button><button class=\"btn btn-sm\">Cut</button><button class=\"btn btn-sm\">Paste</button></div><div class=\"btn-group btn-group-sm\" role=\"group\"><button class=\"btn btn-sm\">Delete</button></div></div><div class=\"panel-group\"><div class=\"panel\"><div class=\"panel-header justify-content-between\">Left Panel Header</div><div class=\"panel-body\">Left Panel Body</div><div class=\"panel-footer\">Left Panel Footer</div></div><div class=\"panel\"><div class=\"panel-header justify-content-between\">Right Panel Header</div><div class=\"panel-body\">Right Panel Body</div></div></div><div class=\"panel-footer\">Main Panel Footer</div></div>"
  ...
  test 'panel with deck' do
    ...
    expected = "<div class=\"panel\"><div class=\"panel-header justify-content-between\"><div class=\"panel-title\">Main panel header</div></div><div class=\"btn-toolbar justify-content-between panel-toolbar\" role=\"toolbar\"><div role=\"group\" class=\"btn-group btn-group-sm mr-2\"><button class=\"btn btn-sm\">Copy</button><button class=\"btn btn-sm\">Cut</button><button class=\"btn btn-sm\">Paste</button></div><div class=\"btn-group btn-group-sm\" role=\"group\"><button class=\"btn btn-sm\">Delete</button></div></div><div class=\"panel-deck-wrapper\"><div class=\"panel-deck\"><div class=\"panel\"><div class=\"panel-header justify-content-between\">Left Panel Header</div><div class=\"panel-body\">Left Panel Body</div><div class=\"panel-footer\">Left Panel Footer</div></div><div class=\"panel\"><div class=\"panel-header justify-content-between\">Right Panel Header</div><div class=\"panel-body\">Right Panel Body</div></div></div></div><div class=\"panel-footer\">Main Panel Footer</div></div>"
  ...
  test 'panel with column' do
    ...
    expected = "<div class=\"panel\"><div class=\"panel-header justify-content-between\"><div class=\"panel-title\">Main panel header</div></div><div class=\"btn-toolbar justify-content-between panel-toolbar\" role=\"toolbar\"><div role=\"group\" class=\"btn-group btn-group-sm mr-2\"><button class=\"btn btn-sm\">Copy</button><button class=\"btn btn-sm\">Cut</button><button class=\"btn btn-sm\">Paste</button></div><div class=\"btn-group btn-group-sm\" role=\"group\"><button class=\"btn btn-sm\">Delete</button></div></div><div class=\"panel-columns\"><div class=\"panel\"><div class=\"panel-header justify-content-between\">Left Panel Header</div><div class=\"panel-body\">Left Panel Body</div><div class=\"panel-footer\">Left Panel Footer</div></div><div class=\"panel\"><div class=\"panel-header justify-content-between\">Right Panel Header</div><div class=\"panel-body\">Right Panel Body</div></div></div><div class=\"panel-footer\">Main Panel Footer</div></div>"
