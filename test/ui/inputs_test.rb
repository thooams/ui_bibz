...
<option value=\"option 1\">option 1</option></datalist>"
    ...
    test 'formula_field' do
      ...
      expected = "<div class=\"input-group formula_field\"><input type=\"text\" name=\"value\" id=\"value\" class=\"formula_field_input form-control\" /><span class=\"formula_field_sign input-group-addon\">=</span><input type=\"text\" name=\"value_formula\" id=\"value_formula\" value=\"\" readonly=\"readonly\" class=\"formula_field_result form-control\" /><span class=\"formula_field_alert input-group-addon\" data-toggle=\"tooltip\"><i class=\"glyph-danger glyph fa fa-exclamation-triangle\"></i></span></div>"
